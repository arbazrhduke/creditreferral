"""
Django settings for defrag project.
...
WSGI_APPLICATION = 'defrag.wsgi.application'
...
EMAIL_HOST = config('EMAIL_HOST', cast=str, default='demo.example.com')
